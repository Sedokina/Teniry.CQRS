...
public class RunInTransactionCommandWithReturnValueTests
{
    ...
    public async Task Should_ThrowException_When_TransactionalHasNoUnitOfWork()
    {
        ...
        // Act
        var act = async () =>
            await dispatcher.DispatchAsync<NoUowUpdateTestDataCommand, string>(new NoUowUpdateTestDataCommand(), new());
    ...
    public async Task Should_CallHandlerInTransaction()
    {
        ...
        var result = await dispatcher
            .DispatchAsync<UpdateTestDataCommand, string>(new UpdateTestDataCommand(), new());
    ...
    private class UpdateTestDataHandler : ICommandHandler<UpdateTestDataCommand, string>, ITransactionalHandler<UnitOfWorkStub>
    {
